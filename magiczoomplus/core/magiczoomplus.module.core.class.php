...
if(!defined('MagicZoomPlusModuleCoreClassLoaded')) {
    ...
    class MagicZoomPlusModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus WordPress module version v5.11.12 [v1.4.6:v4.5.25] -->';
        ...
        function template($params) {
            ...
            return "<a{$link} class=\"MagicZoomPlus\"{$title} id=\"MagicZoomPlusImage{$id}\" href=\"{$img}\" {$rel}><img itemprop=\"image\"{$width}{$height} src=\"{$thumb}\" alt=\"{$alt}\" />{$description}</a><br />" . $message;
        }
