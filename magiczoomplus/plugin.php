...
function WordPress_MagicZoomPlus_send_stat($action = '') {
    ...
    if('working' == 'v5.11.12' || 'working' == 'v4.5.25') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.25&module_version=v5.11.12&platform_name=wordpress&platform_version={$platformVersion}&url={$url}";
...
function  magictoolbox_WordPress_MagicZoomPlus_config_page($id) {
    ...
    <form action="" method="post" id="magiczoomplus-config-form">
            ...
            <p><input type="submit" name="submit" class="button-primary" value="Save settings" />&nbsp;<a href="plugins.php?page=WordPressMagicZoomPlus-config-page&reset_settings=true">Reset to defaults</a></p>
        </form>
